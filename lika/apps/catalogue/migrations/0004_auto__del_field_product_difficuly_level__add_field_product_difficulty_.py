...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.difficuly_level'
        db.delete_column('catalogue_product', 'difficuly_level')

        # Adding field 'Product.difficulty_level'
        db.add_column('catalogue_product', 'difficulty_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.difficuly_level'
        db.add_column('catalogue_product', 'difficuly_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.difficulty_level'
        db.delete_column('catalogue_product', 'difficulty_level')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'difficulty_level': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '1', 'null': 'True', 'blank': 'True'}),
            ...
            'vimeo': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
