...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.filename'
        db.alter_column('catalogue_product', 'filename', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.filename'
        db.alter_column('catalogue_product', 'filename', self.gf('django.db.models.fields.files.FileField')(default='/files/1.pdf', max_length=100))
