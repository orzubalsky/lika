...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.vimeo'
        db.delete_column('catalogue_product', 'vimeo')

        # Adding field 'Product.vimeo_number'
        db.add_column('catalogue_product', 'vimeo_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.vimeo'
        db.add_column('catalogue_product', 'vimeo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.vimeo_number'
        db.delete_column('catalogue_product', 'vimeo_number')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'difficulty_level': ('django.db.models.fields.CharField', [], {'default': "'beginner'", 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'vimeo_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
