...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.difficulty_level'
        db.alter_column('catalogue_product', 'difficulty_level', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Product.difficulty_level'
        db.alter_column('catalogue_product', 'difficulty_level', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True))
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'difficulty_level': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
